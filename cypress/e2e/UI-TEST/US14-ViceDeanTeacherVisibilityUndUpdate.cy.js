...
beforeEach(() => {
  ...
  it('US_14_TC_01 Oluşturulan öğretmenin Name, Phone Number, SSN, User Name bilgileri görülebilmeli', ()=> {
   ...
   editTeacherPage.clickChooseLesson();
   editTeacherPage.changeName(name);
   editTeacherPage.checkIsAdvisor();
   editTeacherPage.checkGender();
   editTeacherPage.changeUserName(name);
